...
!
!! SUBROUTINE TO COMPUTE THE DISTANCES AND VECTORS BETWEEN "NUM_RES" PARTICLES ! PEDRO OJEDA,  07/MAY/2011 USE PARAMETERS
!REAL(DP)            ::  FDUMMY1,FDUMMY2,FDUMMY3
!
!DO I=1,NUM_RES  DO J=I,NUM_RES DIS(I,J)=0.0D0   DIS(J,I)=0.0D0 ENDDO                ENDDO                  
!
!!THE DISTANCES BETWEEN AMINO ACIDS ARE COMPUTED HERE DO 10 I=1,NUM_RES-1                                    DO 20 J=I+1,NUM_RES
!FDUMMY1=PARTICLE(I)%COORX(1)-PARTICLE(J)%COORX(1)                          FDUMMY2=PARTICLE(I)%COORY(1)-PARTICLE(J)%COORY(1)
!FDUMMY3=PARTICLE(I)%COORZ(1)-PARTICLE(J)%COORZ(1)                           
!            
!
!    XDIS(I,J)=FDUMMY1 YDIS(I,J)=FDUMMY2 ZDIS(I,J)=FDUMMY3 XDIS(J,I)=-FDUMMY1 YDIS(J,I)=-FDUMMY2 ZDIS(J,I)=-FDUMMY3
!    DIS(I,J)=SQRT(FDUMMY1*FDUMMY1+FDUMMY2*FDUMMY2+FDUMMY3*FDUMMY3) DIS(J,I)=DIS(I,J)
!
!20  CONTINUE
!
!10  CONTINUE
